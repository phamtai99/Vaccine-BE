...
@RestController
/**
 * Dùng tạo địa chỉ api và mở khóa chặn để truy cập dữ liệu
 */
...
public class VaccinationManagerController {
    ...
    /**
     * Dùng để chỉnh sửa đã thực hiện công việc tiêm chủng định kỳ hoàn thành hay chưa.
     */
    ...
    /**
     *  Dùng để xóa sự kiện tiêm chủng định kỳ
     */
    ...
    /**
     *  Lấy danh sách địa điểm xảy ra sự kiện tiêm chủng định kỳ
     */
    ...
    /**
     *  Lấy danh sách vắc-xin xảy ra sự kiện tiêm chủng định kỳ
     */
